...
func (gen *GinGenerator) generateFile(file *protogen.File) *protogen.GeneratedFile {
	...
	g := gen.gen.NewGeneratedFile(ginFileName, file.GoImportPath)
	g.P("// Code generated by github.com/leiax00/protoc-gen-gin. DO NOT EDIT.")
	g.P()
	g.P("package ", file.GoPackageName)
	g.P()
	g.P("// This is a compile-time assertion to ensure that this generated file is compatible")
	g.P("// with the leiax00/protoc-gen-gin package it is being compiled against.")
